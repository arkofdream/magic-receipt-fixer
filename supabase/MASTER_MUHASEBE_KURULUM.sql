...
-- >>> 20260822000000_faz1a_muhasebe_foundation.sql <<<
-- =============================================================
...
-- >>> 20260822200000_drop_old_create_sales_invoice_overload.sql <<<
-- =============================================================
...
-- >>> 20260822213000_faz21_tevkifat_journal_support.sql <<<
-- =============================================================
...
-- >>> 20260822233000_faz223_stmm_621_153_integration.sql <<<
-- =============================================================
...
-- >>> 20260823000000_faz224_accounting_periods.sql <<<
-- =============================================================
...
-- >>> 20260823010000_faz224_financial_reporting.sql <<<
-- =============================================================
...
-- >>> 20260823020000_faz224_reconciliation_and_audit_engine.sql <<<
-- =============================================================
...
-- >>> 20260823030000_faz225_purchase_invoice_and_supplier_accounting.sql <<<
-- =============================================================
...
-- >>> 20260823040000_faz225_purchase_audit_reconciliation.sql <<<
-- =============================================================
...
-- >>> 20260823050000_faz225_returns_supplier_payments.sql <<<
-- =============================================================
...
-- >>> 20260823060000_faz23_tax_declarations.sql <<<
-- =============================================================
...
-- >>> 20260823070000_faz24_fx_revaluation.sql <<<
-- =============================================================
